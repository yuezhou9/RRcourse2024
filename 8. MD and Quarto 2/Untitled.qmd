...
```{r}
knitr::convert_chunk_header(input = "Untitled.Rmd", output = "Untitled.qmd")
...
| Topic            | Description                                                    |
|------------------|------------------------------------------------------|
| Basic Statistics | According to Wikipedia, Breaking Bad received critical acclaim |
| Viewership       | The show's viewership grew significantly over its run          |

::: tabs
::: {.tab-button onclick="openTab(event, 'basic')"}
Basic Statistics
:::

::: {.tab-button onclick="openTab(event, 'viewership')"}
Viewership Over Time
:::

::: {.tab-button onclick="openTab(event, 'changes')"}
Episode Changes
:::
:::
...
<div id="viewership" class="tab-content">

## Viewership Over Time

```{r}
#| label = "viewership_over_time",
#| echo = FALSE,
#| fig.cap = "Graph of Viewership Over Time"
library(ggplot2)
...
# Hypothetical data for episode changes
...
ggplot(changes_data, aes(x = Episode, y = Viewership_Change, fill = Viewership_Change > 0)) +
  ...
  labs(title = "Hypothetical Episode Changes in Viewership for Breaking Bad",
       x = "Episode",
